...
public class Eight_exercise {
    ...
    public static void ZapisFile(LinkedList<Sotrudnik> info ) throws IOException
    {
    ...
    public static LinkedList<Sotrudnik> ReadFiles(LinkedList<Sotrudnik> sotrud) throws IOException
    {
    ...
    public static void main(String[] args) throws IOException {
        LinkedList <Sotrudnik> List= new LinkedList<Sotrudnik>();
        int menu;
        int indexVstavki;
        Scanner ab = new Scanner(System.in);
        do {
